...
public class Employee extends BaseFragment implements LoaderManager.LoaderCallbacks<Cursor>,
    ...
    public List<ODrawerItem> drawerMenus(Context context) {
        ...
        menu.add(new ODrawerItem(TAG).setTitle("Employee").setInstance(new Employee()));
        return menu;
    }
